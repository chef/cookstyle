...
The `Style/RedundantFileExtensionInRequire` cop detects code that requires libraries using their complete filenames when the `.rb` extension is not necessary.
